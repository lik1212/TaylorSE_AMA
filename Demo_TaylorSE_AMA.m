...
tic
[BranchRes_all, BranchRes_all_exakt, NodeRes_all, NodeRes_all_exakt] = AugmentedMatrix_Algorithm_Benchmark(NodeRes_Name,BranchRes_Name,pseudo,LP_DB_name,PV_DB_name,LP_dist_name,PV_dist_name,Grid_Name);
toc
